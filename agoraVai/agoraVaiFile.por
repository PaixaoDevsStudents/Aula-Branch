programa
{
	...
	funcao vazio calcularreResultColegas(real resultadoDiv, inteiro resultadoCubo[]){
		real result0, result1
		result0=resultadoCubo[0]+resultadoDiv/*+DescontoDoCustoDeConcreto*/
		result1=resultadoCubo[1]+resultadoDiv/*+DescontoDoCustoDeConcreto*/
		se(result0>result1){
			escreva(" ")
		}
	}
